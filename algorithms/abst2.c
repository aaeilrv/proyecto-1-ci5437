...
{
  if( state->vars[ 0 ] == 0 && state->vars[ 1 ] == 0 && state->vars[ 2 ] == 0 && state->vars[ 3 ] == 0 && state->vars[ 4 ] == 3 && state->vars[ 5 ] == 5 && state->vars[ 6 ] == 0 && state->vars[ 7 ] == 0 && state->vars[ 8 ] == 8 && state->vars[ 9 ] == 9 && state->vars[ 10 ] == 0 && state->vars[ 11 ] == 0 && state->vars[ 12 ] == 12 && state->vars[ 13 ] == 0 && state->vars[ 14 ] == 0 && state->vars[ 15 ] == 0 ) {
    return 1;
  }
  return 0;
}
