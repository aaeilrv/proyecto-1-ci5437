...
{
  if( state->vars[ 0 ] == 0 && state->vars[ 1 ] == 0 && state->vars[ 2 ] == 0 && state->vars[ 3 ] == 0 && state->vars[ 4 ] == 0 && state->vars[ 5 ] == 0 && state->vars[ 6 ] == 0 && state->vars[ 7 ] == 0 && state->vars[ 8 ] == 0 && state->vars[ 9 ] == 0 && state->vars[ 10 ] == 10 && state->vars[ 11 ] == 0 && state->vars[ 12 ] == 0 && state->vars[ 13 ] == 13 && state->vars[ 14 ] == 14 && state->vars[ 15 ] == 15 ) {
    return 1;
  }
  return 0;
}
